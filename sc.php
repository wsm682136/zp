  ...
  <![endif]-->
	...
	<script type="text/javascript">
		...
		function create() {
			...
			var myid1 = myid;
			kd.href = 'https://test.qc-keji.com/zp/?id=' + myid.value + '&url=' + url.value; //在这修改域名   替换就行
			kd.style = '';
			kd.innerText = 'https://test.qc-keji.com/zp/?id=' + myid.value + '&url=' + url.value; //两个都要替换    这就好了
	...
	<div class="container">
        ...
        <li role="presentation" class="active"><a href="http://wlopck.gitee.io/">作者博客</a></li>
			...
			<h3 class="text-muted" align="left">
				<img src="https://z3.ax1x.com/2021/04/20/c7NmY6.png" width="150px" height="47px"></img>
				<font color="#8968CD"><b>Echocbx照妖镜</b></font>
			</h3>
		</div>
		<hr class="hr1">
		...
		<div class="panel panel-primary" style="margin:1% 1% 1% 1%;background: rgba(255, 251, 251, 0.8)">
			...
			<div class="panel-body">
				<div class="panel-body">
					...
					<input type="text" style="background: rgba(255, 251, 251, 0.7)" class="form-control" id="myurl" value='#' placeholder="请输入上传照片后要跳转的网址">
					<br>
